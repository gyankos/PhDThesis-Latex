...
%%The operands were stored in secondary memory
%%as Neo4J graphs, as Virtuoso native triple stores and with our proposed implementation. Since
%%Neo4J's query language (Cypher) does not support querying two distinct graphs, both left and
%%right operands were stored in the same graph database.
