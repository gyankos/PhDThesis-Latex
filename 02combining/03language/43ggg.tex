...
\begin{figure*}[!p]
	\centering
	\includegraphics[width=\textwidth]{imgs/examples/00DependencyGraph}
...
\begin{figure*}[!pth]
	\begin{minipage}[b]{\textwidth}
		\centering
		\includegraphics[width=\textwidth]{images/introduction/comparisons/unstructured/diagramtable}
		\subcaption{Query for nested graph allowing to rewrite the full-text graph representation.}
		\label{fig:diagramtable}
	\end{minipage}
	\begin{minipage}[b]{\textwidth}
		\centering
		\includegraphics[width=1.2\textwidth]{images/introduction/comparisons/unstructured/nestedrepr}
...
\begin{figure*}[!pth]
	\centering
	\includegraphics[width=\textwidth]{imgs/examples/01DependencyGraph_match}
