...
\begin{minipage}[t]{0.9\textwidth}
	\centering
	\includegraphics[scale=0.8]{imgs/03introduction/alignments/10rearranged_input.pdf}
...
\begin{minipage}[t]{0.9\textwidth}
	\centering
	\includegraphics[scale=0.8]{imgs/03introduction/alignments/11preserving_aggregation.pdf}
...
\begin{minipage}[t]{0.9\textwidth}
	\centering
	\includegraphics[scale=0.8]{imgs/03introduction/alignments/12_intermediate_aggregation.pdf}
...
\begin{figure}[!t]
	...
	\begin{minipage}[t]{0.5\textwidth}
		\centering
		\includegraphics[scale=0.8]{imgs/03introduction/alignments/13actual_schema.pdf}
