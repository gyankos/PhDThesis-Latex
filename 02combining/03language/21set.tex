...
\begin{figure}[!t]
	...
	\begin{minipage}[t]{0.9\textwidth}
		\centering
		\includegraphics[scale=0.8]{imgs/11language/03setop_operands.pdf}
	...
	\begin{minipage}[t]{0.3\textwidth}
		\centering
		\includegraphics[scale=0.8]{imgs/11language/04setop_union.pdf}
		\subcaption{$n^L\cup n^R:=\bigcup\{n^L,n^R\}$}
		\label{fig:setunion}
	\end{minipage}\begin{minipage}[t]{0.3\textwidth}
	\centering
	\includegraphics[scale=0.8]{imgs/11language/06setop_intersection.pdf}
	\subcaption{$n^L\cap n^R:=\bigcap\{n^L,n^R\}$}
	\label{fig:setintersection}
\end{minipage}\begin{minipage}[t]{0.1\textwidth}
	\centering
	\includegraphics[scale=0.8]{imgs/11language/05setop_difference.pdf}
