...
graph databases representing % are used as
MOLAP multi-dimensional for data warehouses, in which different types of data are %where such kind of data is 
