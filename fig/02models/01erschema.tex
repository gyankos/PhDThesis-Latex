...
\begin{document}
	...
	draw=green!50!black!100, drop shadow]
		...
		\node[attribute] (ege) [below=of emp] {Gender} edge (emp);
		
		\node[relationship] (proc) [right=2cm of emp] {Processes};
		\draw[-] (proc) -- (emp) node [near end,above] {0..N};
		
		\node[entity] (order) [right=2cm of proc] {SalesOrder};
		...
		\node[attribute] (cqt) [below left=1.5 cm of comp] {Quantity} edge (comp);
