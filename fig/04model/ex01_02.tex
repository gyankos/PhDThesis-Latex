...
%	};
	...
	\filldraw[fill=blue!20,opacity=.3,draw=blue,line width=4pt] (a1.south west) 
									    to[in=-200,out=0]
									   (a6.south west)
									    --
									   (a6.south east)
	...
	\filldraw[fill=red!40,opacity=.3,loosely dotted,line width=4pt,draw=red] (a6.north west)
	--
	(a5.north west)
	--
	(a5.north east)
	...
	\filldraw[fill=green!30,opacity=.3,draw=green,densely dotted,line width=4pt] (a1.north west)
	--
	(a1.north east)
	--
	(a6.north east)
