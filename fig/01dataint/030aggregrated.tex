...
\usepackage{geometry}
\usepackage{amssymb}
\geometry{paperwidth=100mm,paperheight=75mm,scale=1,showframe}
...
%\begin{groupme}
  ...
  \noindent\tikzmark{B}\begin{tabular}{ | *{2}{c|}  }
    ...
    & \headcell{\markme{$\boxminus$ quantity}} \\
    \hline
    House Cleaner &  \begin{tabular}[t]{ | *{2}{l|} }
      \firsthline
      \firstsubheadcell{category} & \subheadcell{$\boxminus$ quantity}\\
      \hline
      Cleaner & {\begin{tabular}[t]{ | *{2}{c|} }
          \firsthline
          \firstsubheadcell{product}& \subheadcell{quantity} \\
          \hline
          Shiny & 1\\
        \end{tabular}} \cr
      \hline
      Soap & {\begin{tabular}[t]{ | *{2}{c|} }
      		\firsthline
      		\firstsubheadcell{product} & \subheadcell{quantity} \\
      		\hline
      		Marseille & 10\\
    ...
    Food &  \begin{tabular}[t]{ | *{2}{l|} }
    	...
    	\firstsubheadcell{category} & \subheadcell{$\boxminus$ quantity}\\
    	\hline
    	Diary Product & {\begin{tabular}[t]{ | *{2}{c|} }
    			\firsthline
    			\firstsubheadcell{product} & \subheadcell{quantity} \\
    			\hline
    			Milk & 2\\
